...
class BLOCKids_Configurator
{
    ...
    private function includes()
    {
        ...
        require_once BLOCKIDS_CONFIGURATOR_PLUGIN_DIR . 'includes/class-grip-scanner.php';
        ...
        require_once BLOCKIDS_CONFIGURATOR_PLUGIN_DIR . 'includes/class-registration.php';
    ...
    private function init_hooks()
    {
        ...
        add_action('elementor_pro/forms/actions/register', function ($form_actions_registrar) {
            require_once BLOCKIDS_CONFIGURATOR_PLUGIN_DIR . 'includes/class-registration-form-action.php';
            $form_actions_registrar->register(new BLOCKids_Registration_Form_Action());
        });
    }
    ...
    public function init()
    {
        ...
        BLOCKids_Configurator_Registration::init();
        BLOCKids_Configurator_API::init();
    }
